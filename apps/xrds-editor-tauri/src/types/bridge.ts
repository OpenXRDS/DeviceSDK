...
export type NodePayload =
  | { type: "Empty" }
  | { type: "Cube";     material: MaterialParams }
  | { type: "Sphere";   material: MaterialParams }
  | { type: "Cylinder"; material: MaterialParams }
  | { type: "Plane";    material: MaterialParams }
  ...
  | { type: "Player" }
  | { type: "PlayerAnchor"; fov_deg: number; is_initial: boolean }
...
export const KIND_ICON: Record<string, string> = {
  ...
  HudText: "HUD", AudioClip: "♪", InteractionZone: "⬡", PlayerSpawn: "🧍", Player: "🎮", PlayerAnchor: "📍",
  Empty: "○",
};
