...
use xrds::scene_graph::{
    ...
    XrdsSceneExtrudedText, XrdsSceneTetrahedron, XrdsSceneText, XrdsSceneTransform,
};
...
pub fn primitive_payload_from_label(label: &str) -> Option<XrdsSceneNodePayload> {
    match label {
        ...
        "Extruded Text" => Some(XrdsSceneNodePayload::ExtrudedText(
            XrdsSceneExtrudedText::default(),
        )),
        _ => None,
    }
}
    ...
    let groups: &[&[(Option<IconName>, &str, NodeBuilder)]] = &[
        ...
        &[
            ...
            (
                ...
                "Extruded Text",
                Box::new(|| {
                    XrdsSceneNodePayload::ExtrudedText(XrdsSceneExtrudedText::default())
                }),
            ),
        ],
    ];
