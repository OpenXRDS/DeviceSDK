...
impl Constant {
    ...
    /// VertexID is started from 2. 0 and 1 is reserved for instance buffer (curr/prev)
    pub const VERTEX_ID_BASEMENT: u32 = 2;
    ...
    pub const INTERMEDIATE_MOTION_VECTOR_FORMAT: wgpu::TextureFormat =
    ...
    pub const TAA_SAMPLE_COUNT: u64 = 8;
}
